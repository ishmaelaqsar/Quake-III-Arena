...
// C linkage to match the definition in code/renderer/tr_init.cpp, which tr_local.h
// declares inside its extern "C" block. See cl_cgame.cpp for why only MSVC cares.
extern "C" glconfig_t glConfig;
